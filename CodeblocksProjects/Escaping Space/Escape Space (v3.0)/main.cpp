...
//If player has not fixed the solar cell yet
        ...
        if( inputValue == 3)
        {
            ...
            if( foundMaterials[5] >= 1 && foundMaterials[1] >= 1 && foundMaterials[0] >= 1 && recoveredPower[0] == false)
            {
                ...
                cout << "//For several mineutes, no explosions or fires occur so you feel reasonably safe" << endl;
                cout << endl;
...
//If input is invalid, print an error message
            ...
            if( inputValue != 9 && enterAnything != "a" && enterAnything != "A" && playerItems[inputValue] != 0 )
            {
                cout << endl;
