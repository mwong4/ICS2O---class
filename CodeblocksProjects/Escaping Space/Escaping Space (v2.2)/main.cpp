...
int suppliesRoom( string, string, int, int[], int, int[], int, bool, int, string[], bool[]); //Thecommand deck requires a player name, location, authority, playerStats, foundMaterials, knowing if player is starting, scenario, playerItemsStrings and knowing if the player is scavanging
int commsRoom( string, string, int, int[], int, int[], int, bool, int, string[], bool[]); //Thecommand deck requires a player name, location, authority, playerStats, foundMaterials, knowing if player is starting, scenario, playerItemsStrings and knowing if the player is scavanging
