...
>-
>- [TO DO]
>- Make experience actually do something
>-  +Strength
>-  +Combat
>-
>- Add death
...
void checkInput( string, string, string, int, bool, int [], int [], int ); //This function is used in order to check if the input will call a menu tab

int habRoom( string, string, int, int[], int, int[], int, bool, int, string[], bool[], bool[], bool[] ); //What the player experiences when waking up. Requires a player name, location, authority, playerStats, foundMaterials, knowing if player is starting, scenario, playerItemsStrings, knowing if the player is scavanging and knowing if power is restored
...
int suppliesRoom( string, string, int, int[], int, int[], int, bool, int, string[], bool[]); //The spply room requires a player name, location, authority, playerStats, foundMaterials, knowing if player is starting, scenario, playerItemsStrings and knowing if the player is scavanging
...
int main()
{
    ...
    playerChoice = habRoom( playerName, locationSerialCode, adminPower, playerStats, 6, foundMaterials, 10, starting, scenario, playerItemsStrings, scavanged, recoveredPower, wokeUp);
    ...
    while( playingGame == true )
    {
        ...
        if(playerChoice == 10)
        {
            ...
            playerChoice = suppliesRoom( playerName, locationSerialCode, adminPower, playerStats, 6, foundMaterials, 10, starting, scenario, playerItemsStrings, scavanged );
        }
...
void escapePod( string playerName, string location, int adminAuth )
{
    ...
    cout << endl;
    cout << "Thanks to:" << endl;
    cout << "               >- Vedaant Srivastava for the error trapping system" << endl;
...
int commsRoom( string playerName, string location, int adminAuth, int playerStats[], int statsSize, int foundMaterials[], int materialsSize, bool starting, int scenario, string itemNames[], bool scavanged[] )
{
    ...
    while( usingRoom == true )
    {
        ...
        checkInput( inputAnything, playerName, location, adminAuth, starting, playerStats, foundMaterials, scenario );
        ...
        if( inputValue != 1 && inputValue != 2 && inputAnything != "a" && inputAnything != "A" && inputAnything != "i" && inputAnything != "I" && inputAnything != "m" && inputAnything != "M" && inputAnything != "v" && inputAnything != "V")
        {
            printInputError();
            system("CLS");
        }
...
//supply room
int suppliesRoom( string playerName, string location, int adminAuth, int playerStats[], int statsSize, int foundMaterials[], int materialsSize, bool starting, int scenario, string itemNames[], bool scavanged[] )
{
    bool usingRoom = true; //This bool holds true if the player is using the room. Turn false to end the loop
...
int commandDeck( string playerName, string location, int adminAuth, int playerStats[], int statsSize, int foundMaterials[], int materialsSize, bool starting, int scenario, string itemNames[], bool scavanged[] )
{
    ...
    while( usingRoom == true )
    {
        ...
        cout << endl;
        cout << "//Your hopes of escape slip slghtly when you realize the majority of the computers have been destroyed" << endl;
...
int habRoom( string playerName, string location, int adminAuth, int playerStats[], int statsSize, int foundMaterials[], int materialsSize, bool starting, int scenario, string itemNames[], bool scavanged[], bool recoveredPower[], bool wokeUp[] )
{
    std::string inputAnything = "";// Variable where you can input anything
...
//Showing what items are in the inventory
        if(playerItems[0] != 0)
        {
            cout << ">- [1] Duct Tape Role: x" << playerItems[0] << endl;
        }
        if(playerItems[1] != 0)
        {
...
//
void checkInput( string inputAnything, string playerName, string location, int adminAuth, bool starting, int playerStats[], int foundMaterials[], int scenario )
{
