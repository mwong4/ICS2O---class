...
void itemsMenu( int [], string, string, int ); //Menu that allows the player to see and use collected items. Requires the item list array, player name, location and authority
...
void itemsMenu ( int playerItems[], string playerName, string serialCode, int auth)
{
    consolHeader( playerName, serialCode, auth);
}
