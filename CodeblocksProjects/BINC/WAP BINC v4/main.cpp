...
void div( float, float, float, float); //This function is used to perform the division operation
...
//Some formatting/spacing
    ...
    while ( endProgram == false )
    {
        ...
        if( operation == 4)
        {
            div (firstInput, secondInput, thirdInput, fourthInput );
        }
        if( operation == 9)
        {
            endProgram = true;
...
int chooseOperation ()
{
    ...
    do
    {
        ...
        if( opSelected != 1 && opSelected != 2 && opSelected != 3 && opSelected != 4 && opSelected != 9)
        {
            printErrorInput();
        }
    }
    while ( opSelected != 1 && opSelected != 2 && opSelected != 3 && opSelected != 4 && opSelected != 9);
...
void mul ( float a, float b, float c, float d )
{
    ...
    cout << " ans = ( " << a << " + " << b << "i ) ( " << c << " + " << d << "i )" << endl;
    cout << endl;
    cout << " ans = " << a * c << " + " << a * d << " i + " << b * c << "i + " << b * d << "*i^2" << endl;
    cout << endl;
...
//Displaying the division calculations
void div ( float a, float b, float c, float d )
{

    cout << endl;
    cout << "       Formula" << endl;
    cout << " ans = ( a + bi / c + di )" << endl;
    cout << endl;
    cout << endl;
    cout << " ans = ( " << a << " + " << b << "i ) / " << c << " + " << d << "i )" << endl;
    cout << endl;
    cout << " ans = ( " << a << " + " << b << "i ) / " << c << " + " << d << "i ) * 1" << endl;
    cout << endl;
    cout << " ans = {( " << a << " + " << b << "i ) / " << c << " + " << d << "i )} * {( " << c << " - " << d << "i / " << c << " - " << d << "i )}" << endl;
    cout << endl;
    cout << endl;
    cout << ">- since i = sqrt( -1 ), i squared is equal to (-1)" << endl;
    cout << endl;
    cout << endl;
    cout << " ans = ( " << a << "*" << c << " - " << a << "*" << d << "i + " << b << "*" << c << "i - " << b << "*" << d << "(-1) ) / ( " << c << "^2 - " << d << "i^2 )" << endl;
    cout << endl;
    cout << " ans = ( " << a*c << " - " << a*d << "i + " << b*c << "i + " << b*d << " ) / ( " << c*c << " + " << d*d << " )" << endl;
    cout << endl;
    cout << " ans = ( " << a*c << " + " << b*d << " + i(" << b*c << " - " << a*d << ") ) / ( " << c*c << " + " << d*d << " )" << endl;
    cout << endl;
    cout << " ans = ( " << ( a * c ) + ( b * d ) << " + " << ( b * c ) - ( a * d ) << "i) ) / ( " << ( c * c ) + ( d * d ) << " )" << endl;
