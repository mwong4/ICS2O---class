...
bool stringChecker( string currentNumber )
{
    ...
    {
        if ( ( currentNumber[i] != '0' ) && ( currentNumber[i] != '1' ) && ( currentNumber[i] != '2' ) && ( currentNumber[i] != '3' ) && ( currentNumber[i] != '4' ) && ( currentNumber[i] != '5' ) && ( currentNumber[i] != '6' ) && ( currentNumber[i] != '7' ) && ( currentNumber[i] != '8' ) && ( currentNumber[i] != '9' ) && ( currentNumber[i] != '.' ) && ( currentNumber[i] != '-' ))
        {
            return false;
        }
    }
